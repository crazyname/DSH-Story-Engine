...
| Browser transaction bridge load/list/save 与 Host response path/revision identity fail-closed | `HOST_API.md` | `client/story-ui/src/client/host-transactions.ts` | `client/story-ui/test/host-transactions.test.ts` | 尚未执行本地 Windows 验收 | D2a 已实现，待验证 |
